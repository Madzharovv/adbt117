  ...
  for (int topsquares=0; topsquares<10; topsquares+=1) {
    for (int topsquares2=0; topsquares2<2; topsquares2+=1) {
      if ((topsquares + topsquares2 + 1) % 2 == 0) {
        fill(random(621), random(50), random(221));
      } else {
        fill(random(873), random(50), random(211));
      }
      rect(topsquares*100+random(15)+25, topsquares2*100+random(15)+25, random(50, 10), random(50, 10));
    }
  }
}
void leftsquares() {
  for (int leftsquares=0; leftsquares<2; leftsquares+=1) {
    for (int leftsquares2=0; leftsquares2<10; leftsquares2+=1) {
      ...
      rect(leftsquares*100+random(15)+25, leftsquares2*100+random(15)+25, random(50, 10), random(50, 10));
    }
  }
}
void rightsquares() {
  for (int rigthtsquares=0; rigthtsquares<2; rigthtsquares+=1) {
    for (int rigthtsquares2=0; rigthtsquares2<10; rigthtsquares2+=1) {
      ...
      rect(rigthtsquares*100+random(15)+825, rigthtsquares2*100+random(15)+25, random(50, 10), random(50, 10));
    }
  }
}
void bottomsquares() {
  for (int bottomsquares=0; bottomsquares<10; bottomsquares+=1) {
    for (int bottomsquares2=0; bottomsquares2<2; bottomsquares2+=1) {
      ...
      rect(bottomsquares*100+random(15)+25, bottomsquares2*100+random(15)+825, random(50, 10), random(50, 10));
    }
  }
}
void rightcircle() {
  for (int rightcircle=0; rightcircle<2; rightcircle+=1) {
    for (int rightcircle2=0; rightcircle2<6; rightcircle2+=1) {
      ...
      ellipse(rightcircle*100+random(15)+650, rightcircle2*100+random(15)+250, random(50, 10), random(50, 10));
    }
  }
}
void leftcircle() {
  for (int leftcircle=0; leftcircle<2; leftcircle+=1) {
    for (int leftcircle2=0; leftcircle2<6; leftcircle2+=1) {
      ...
      ellipse(leftcircle*100+random(15)+250, leftcircle2*100+random(15)+250, random(50, 10), random(50, 10));
    }
  }
}
void topcircle() {
  for (int topcircle=0; topcircle<2; topcircle+=1) {
    for (int topcircle2=0; topcircle2<2; topcircle2+=1) {
      ...
      ellipse(topcircle*100+random(15)+450, topcircle2*100+random(15)+250, random(50, 10), random(50, 10));
    }
  }
}
void bottomcircle() {
  for (int bottomcircle=0; bottomcircle<2; bottomcircle+=1) {
    for (int bottomcircle2=0; bottomcircle2<2; bottomcircle2+=1) {
      ...
      ellipse(bottomcircle*100+random(15)+450, bottomcircle2*100+random(15)+650, random(50, 10), random(50, 10));
    }
  }
}
